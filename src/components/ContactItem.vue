...
/// computed property to display both id and name 
...
/// added check to prevent saving empty fields
function onSave () {
...
/// trigger edit mode if created empty card in list
onMounted(() => {
...
/// delete new card if pressed cencel button
